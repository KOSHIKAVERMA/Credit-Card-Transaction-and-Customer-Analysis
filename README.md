...
In this project, I uncovered key insights and behavioral patterns in credit card usage by customers using Power BI. I analyzed crucial metrics such as customer age, gender, marital status, occupation, and education level. By the end, I gained a clearer understanding of how customers use their credit cards, enabling me to predict their needs and provide meaningful insights to the company.
